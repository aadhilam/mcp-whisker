...
export class CalicoWhiskerMCPServer {
    ...
    async handleConnectToCluster(args) {
    ...
    async handleGetDeniedStagedPolicies(args) {
    ...
    async handleGetPolicyViolations(args) {
    ...
    async handleGetHighTrafficFlows(args) {
    ...
    async handleGetNamespaceFlows(args) {
    ...
    async handleGenerateNetworkPolicies(args) {
    ...
    async handleGetKubeconfigContexts(args) {
    ...
    async handleCheckKubeconfig(args) {
        const { kubeconfigPath } = args;
    ...
    async handleDiagnoseConnection(args) {
        const { kubeconfigPath } = args;
        const configPath = kubeconfigPath || this.k8sService.getDefaultKubeconfigPath();
        try {
    ...
    async handleGetNamespaceFlowSummary(args) {
        const { namespace } = args;
        if (!namespace) {
            return {
                content: [
    ...
    async handleAnalyzeBlockedFlows(args) {
        const { namespace } = args;
        try {
